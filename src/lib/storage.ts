...
import pfL from '../data/pfL.json';
import pfR from '../data/pfR.json';
import {
  StorageObject,
  StorageData,
  ParkFactors,
...
export enum storageInsertActions {
  "SET",
  "UNSET"
}
...
export async function resetStorageItem(storageKey: STORAGE_KEYS) {
